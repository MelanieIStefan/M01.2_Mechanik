...
\begin{center}
\includegraphics[width=0.6\textwidth, angle=90]{rowing.jpg}
\end{center}
...
\begin{center}
\includegraphics<1>[width=0.8\textwidth]{rudern_hebel_1.png}
\includegraphics<2>[width=0.8\textwidth]{rudern_hebel_2.png}
\includegraphics<3>[width=0.8\textwidth]{rudern_hebel_3.png}
\includegraphics<4>[width=0.8\textwidth]{rudern_hebel_4.png}
\includegraphics<5>[width=0.8\textwidth]{rudern_hebel_4.5.png}
\includegraphics<6>[width=0.8\textwidth]{rudern_hebel_5.png}
\end{center}
...
\item
Hebelgesetz beim Rudern. Mein eigenes Werk, CC BY-SA 4.0, 2022.
